...
type Contract struct {
	...
	// EVMOnly указывает, что контракт должен выполняться только на стандартном EVM
	// и не должен использовать квантовый процессор Quest
	EVMOnly bool
...
// SetEVMOnly устанавливает флаг, что контракт должен выполняться только на стандартном EVM
func (c *Contract) SetEVMOnly(evmOnly bool) {
	c.EVMOnly = evmOnly
}
